...
class OrganizationIntegrationTest extends AbstractIntegrationTest {
    ...
    void shouldCreateCompany() {
        Map<String, Object> createRequest = Map.of("organizationId", UUID.randomUUID().toString(), "name",
                "Test Company SA", "taxId", "B12345678", "currencyCode", "EUR", "fiscalRegime", "COMMON",
        ...
        ResponseEntity<ApiResponse<Map<String, Object>>> response = restTemplate.exchange("/api/v1/companies",
                HttpMethod.POST, new HttpEntity<>(createRequest, bootstrapHeaders),
    ...
    void shouldUpdateFiscalSettings() {
        ...
        Map<String, Object> updateRequest = Map.of("fiscalRegime", "SII", "priceIncludesTax", false, "roundingMode",
                "TOTAL");
        ResponseEntity<ApiResponse<Map<String, Object>>> response = restTemplate.exchange(
                "/api/v1/companies/" + companyId + "/fiscal-settings", HttpMethod.PUT,
    ...
    void shouldCreateStoreWithAutoWarehouse() {
        ...
        Map<String, Object> createRequest = Map.of("companyId", companyId.toString(), "code", "STORE001", "name",
        ...
        ResponseEntity<ApiResponse<Map<String, Object>>> response = restTemplate.exchange("/api/v1/stores",
                HttpMethod.POST, new HttpEntity<>(createRequest, authHeaders),
                new ParameterizedTypeReference<ApiResponse<Map<String, Object>>>() {
                });
        ...
        Integer warehouseCount = jdbcClient.sql("SELECT COUNT(*) FROM warehouses WHERE id = ?").param(warehouseId)
                .query(Integer.class).single();
    ...
    protected UUID createTestCompany() {
        testCompanyId = super.createTestCompany();
