...
class AdminCampaignControllerIntegrationTest extends AbstractIntegrationTest {
    ...
    void testCreateDraft_Success() throws Exception {
        ...
        CreateCampaignRequest request = new CreateCampaignRequest("My Campaign", template.getId(),
                new AudienceFilter(null, null, "CLIENT"));
        mockMvc.perform(
                post("/api/v1/companies/{companyId}/marketing/campaigns/draft", globalCompanyId)
