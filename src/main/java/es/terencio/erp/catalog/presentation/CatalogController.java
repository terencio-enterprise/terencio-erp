...
public class CatalogController {
        ...
        public CatalogController(
                        ListTaxesUseCase listTaxesUseCase,
        ...
        public ResponseEntity<ApiResponse<List<TaxResponse>>> listTaxes(@RequestParam UUID companyId) {
                List<Tax> taxes = listTaxesUseCase.listTaxes(new CompanyId(companyId));
        ...
        public ResponseEntity<ApiResponse<CategoryResponse>> createCategory(
                ...
                return ResponseEntity
                                .ok(ApiResponse.success("Category created successfully",
                                                new CategoryResponse(saved.id(),
                                                                saved.parentId(), saved.name(), saved.color(),
                                                                saved.isActive())));
        }
        ...
        public ResponseEntity<ApiResponse<List<ProductResponse>>> searchProducts(
                ...
                List<Product> products = searchProductsUseCase.search(
