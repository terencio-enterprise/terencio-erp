...
public class CampaignScheduler {
    ...
    private final CampaignLaunchUseCase launchCampaignUseCase;

    public CampaignScheduler(CampaignRepositoryPort repository, CampaignLaunchUseCase launchCampaignUseCase) {
