...
/**
 * Warehouse entity.
 * Represents a logical storage location tied to a Store.
 * Business rule: One warehouse per store in this version.
 */
public class Warehouse {
    ...
    public Warehouse(
        ...
        if (id == null)
            throw new InvariantViolationException("Warehouse ID cannot be null");
        if (storeId == null)
            throw new InvariantViolationException("Warehouse must belong to a store");
        if (name == null || name.isBlank())
            throw new InvariantViolationException("Warehouse name cannot be empty");
