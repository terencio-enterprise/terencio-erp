...
public class Store {
    ...
    public Store(
        ...
        if (id == null)
            throw new InvariantViolationException("Store ID cannot be null");
        if (companyId == null)
            throw new InvariantViolationException("Store must belong to a company");
        if (code == null || code.isBlank())
            throw new InvariantViolationException("Store code cannot be empty");
        if (name == null || name.isBlank())
            throw new InvariantViolationException("Store name cannot be empty");
